...
signal activate_slider_5
signal activate_slider_7
signal return_to_1
...
func _on_jump_slider_5_return_to_4():
	self.SPEED = -25000
	$middle.visible = true


func _on_jump_slider_7_return_to_4_again():
	self.SPEED = -25000
	$top.visible = true
